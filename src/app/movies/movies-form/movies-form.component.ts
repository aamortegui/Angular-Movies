...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, MatButtonModule, RouterLink, MatFormFieldModule, MatInputModule, MatDatepickerModule, InputImgComponent, MultipleSelectorComponent, ActorsAutocompleteComponent],
